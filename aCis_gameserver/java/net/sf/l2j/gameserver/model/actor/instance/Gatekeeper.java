...
public final class Gatekeeper extends Folk
{
	...
	public void showChatWindow(Player player, int val)
	{
		...
		if (getNpcId() == 50010)
		{
			...
			html.replace("%timer%", String.format("%02d:%02d:%02d", (timerInSeconds / 3600), (timerInSeconds % 3600) / 60, (timerInSeconds % 60)));
			html.replace("%name%", RandomZoneTaskManager.getInstance().getName());
