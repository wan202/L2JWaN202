...
public class CharSelectInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		for (int i = 0; i < size; i++)
		{
			...
			writeD(isDressMe ? slot.getDressMe().gloves() : slot.getPaperdollObjectId(Paperdoll.GLOVES));
			writeD(isDressMe ? slot.getDressMe().chest() : slot.getPaperdollObjectId(Paperdoll.CHEST));
			writeD(isDressMe ? slot.getDressMe().legs() : slot.getPaperdollObjectId(Paperdoll.LEGS));
			writeD(isDressMe ? slot.getDressMe().feet() : slot.getPaperdollObjectId(Paperdoll.FEET));
			writeD(slot.getPaperdollObjectId(Paperdoll.CLOAK));
			writeD(slot.getPaperdollObjectId(Paperdoll.RHAND));
			writeD(isDressMe ? slot.getDressMe().hair() : slot.getPaperdollObjectId(Paperdoll.HAIR));
			...
			writeD(isDressMe ? slot.getDressMe().gloves() : slot.getPaperdollItemId(Paperdoll.GLOVES));
			writeD(isDressMe ? slot.getDressMe().chest() : slot.getPaperdollItemId(Paperdoll.CHEST));
			writeD(isDressMe ? slot.getDressMe().legs() : slot.getPaperdollItemId(Paperdoll.LEGS));
			writeD(isDressMe ? slot.getDressMe().feet() : slot.getPaperdollItemId(Paperdoll.FEET));
			writeD(slot.getPaperdollItemId(Paperdoll.CLOAK));
			writeD(slot.getPaperdollItemId(Paperdoll.RHAND));
			writeD(isDressMe ? slot.getDressMe().hair() : slot.getPaperdollItemId(Paperdoll.HAIR));
