...
public class UserInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		writeD(dress != null ? dress.gloves() : _player.getInventory().getItemObjectIdFrom(Paperdoll.GLOVES));
		writeD(dress != null ? dress.chest() : _player.getInventory().getItemObjectIdFrom(Paperdoll.CHEST));
		writeD(dress != null ? dress.legs() : _player.getInventory().getItemObjectIdFrom(Paperdoll.LEGS));
		writeD(dress != null ? dress.feet() : _player.getInventory().getItemObjectIdFrom(Paperdoll.FEET));
		writeD(_player.getInventory().getItemObjectIdFrom(Paperdoll.CLOAK));
		writeD(_player.getInventory().getItemObjectIdFrom(Paperdoll.RHAND));
		writeD(dress != null ? dress.hair() : _player.getInventory().getItemObjectIdFrom(Paperdoll.HAIR));
		...
		writeD(dress != null ? dress.gloves() : _player.getInventory().getItemIdFrom(Paperdoll.GLOVES));
		writeD(dress != null ? dress.chest() : _player.getInventory().getItemIdFrom(Paperdoll.CHEST));
		writeD(dress != null ? dress.legs() : _player.getInventory().getItemIdFrom(Paperdoll.LEGS));
		writeD(dress != null ? dress.feet() : _player.getInventory().getItemIdFrom(Paperdoll.FEET));
		writeD(_player.getInventory().getItemIdFrom(Paperdoll.CLOAK));
		writeD(_player.getInventory().getItemIdFrom(Paperdoll.RHAND));
		writeD(dress != null ? dress.hair() : _player.getInventory().getItemIdFrom(Paperdoll.HAIR));
